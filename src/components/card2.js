...
export default function Card2({ cost, stars, image }) {
  let starsArray = []
  for (let i = 0; i < 5; i++) {
    if (i < stars) {
  ...
  return (
    <div class="card  border overflow-hidden mt-2 mx-1">
      <div class="relative bg-teal-400 pb-5/6 rounded-lg overflow-hidden shadow-lg">
        <img class="absolute h-full w-full object-cover" src={image}></img>
      </div>

      <div class="relative text-sm p-5 pt-3 mx-4 -mt-12 bg-white  rounded-lg border shadow-xl">
        ...
        <h4 class="font-bold text-gray-900 mt-1 text-lg leading-tight truncate">
