    ...
    <div class="lg:flex bg-gray-100 ">
      <div class="lg:w-1/2">
        <div class=" sm:max-w-xl sm:mx-auto px-8 py-12 lg:px-12 lg:py-24 xl:ml-auto xl:mx-0 xl:max-w-lg">
          ...
          <Link
            class="mt-4 sm:mt-6 inline-block bg-indigo-600 uppercase tracking-wider text-white text-sm  py-3 px-5 hover:shadow-outline focus:shadow-outline hover:bg-indigo-400 active:bg-indigo-800 rounded-md font-bold "
            to="/"
          >
            Book your escape
          </Link>
